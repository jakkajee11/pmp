/**
 * Objectives Page Error Boundary
 *
...
export default function ObjectivesError({
  ...
  return (
    <PageErrorFallback
      error={error}
      onReset={reset}
      title="Objectives Error"
      message="Unable to load objectives. Please try refreshing the page or contact your manager if the problem persists."
    />
  );
}
